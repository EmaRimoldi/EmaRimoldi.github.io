...
export function SiteHeader() {
  ...
  return (
    <header className="site-header border-b border-[#c4b6a8]/30">
      <nav className="site-container">
        {isHomepage ? (
          ...
          <div className="flex items-center justify-between gap-6 md:gap-8 lg:gap-10">
            <Link
              href="/"
              className="font-serif text-xs md:text-sm lg:text-base font-medium text-[#251f1d] hover:opacity-60 transition-opacity duration-200 whitespace-nowrap tracking-tight"
            >
              {siteConfig.name}
            </Link>
